...
void loop() {
  ...
  http.addHeader("x-api-token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2wiOiJESVNQT1NJVElWTyIsImlhdCI6MTcwNjcyNzY2OX0.ty5e4gYdhYi3R-5Ppkz1GJP40QMD3VLLoSPSsn3Ptpo");
...
void setup() {
  ...
  doc["identificador"] = 2;                        
  doc["nombre"] = "Area de Contabilidad";               
  doc["latitud"] = -4.037117820395038;                  
  doc["longitud"] = -79.20424311428734;                 
